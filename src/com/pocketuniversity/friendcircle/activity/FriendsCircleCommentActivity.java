...
public class FriendsCircleCommentActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		method = C.ADDFRIENDCIRCLECOMMENT;
		findView();
		setListener();
		initAction();
	}
	...
	private void initAction(){
		...
		headerLayout.showLeftBackButton(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				FriendsCircleCommentActivity.this.finish();
			}
		});
				...
				new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if (commentcontent.length() == 0) {
							new SweetAlertDialog(FriendsCircleCommentActivity.this,SweetAlertDialog.WARNING_TYPE)
							.setTitleText("评论不能为空")
							.setConfirmText("确定")
							.setCancelText("取消")
