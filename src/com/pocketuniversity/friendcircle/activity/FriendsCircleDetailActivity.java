...
public class FriendsCircleDetailActivity extends BaseActivity implements
...
//				comment_list.setAdapter(adapter);
				List<Comment> list;
				list = dbHelper.queryCommentDynamic(currentPage * currentPageSize + "");
				commentdata.clear();
			...
			protected void doInBack() throws Exception {
				...
				param.put("currentPageSize", currentPageSize+"");
				jsonstr = new WebService(C.GETFRIENDCIRCLECOMMENT, param)
						.getReturnInfo();
				temp = GetObjectFromService.getFriendsCircleCommentList(jsonstr);
	...
	private void initView() {
		...
		headerLayout.showLeftBackButton(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent2.putExtra("id", curPost.getId());
		...
		headerLayout.showRightImageButton(R.drawable.ic_campus_comment_send2, new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(FriendsCircleDetailActivity.this, FriendsCircleCommentActivity.class);
				intent.putExtra("postId", curPost.getId());
				FriendsCircleDetailActivity.this.startActivityForResult(intent, 0);
		...
		comment_list = (XListView) findViewById(R.id.comment_list);
		comment_list.setPullRefreshEnable(false);
		...
		ll_zan.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(FriendsCircleDetailActivity.this, ZanUserActivity.class).putExtra("post", id));
	...
	public boolean setData(Intent intent) {
		curPost = (FriendsCircle) intent.getSerializableExtra("post");
	...
	protected void onDestroy() {
		...
		intent2.putExtra("id", curPost.getId());
		intent2.putExtra("position", position);
		FriendsCircleDetailActivity.this.setResult(1001,intent2);
