...
import com.pocketuniversity.adapter.ReminderAdapter.ViewHolder;
...
public class HasFinishReminderAdapter extends BaseAdapter{
	private List<Reminder> list;
	private Context context;
	private LayoutInflater inflater;
	public HasFinishReminderAdapter(Context context,List<Reminder> list,LayoutInflater inflater){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.item_hasfinish_reminder, null);
		...
		viewHolder.createTime.setText(reminder.getFinishTime());
		viewHolder.remindTime.setVisibility(View.GONE);
