 ...
 */
package com.pocketuniversity.browser.greendroid;
...
//		popupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 70);// 距离底部的位�?
		 boolean isFullScreen = UserPreference.read("fullScreen", false);
	        if (isFullScreen) {    
	    //    	 showAtLocation(anchor, Gravity.TOP, mPopupY ,50);//	
	        	 showAsDropDown(anchor);
	        } else{ 
	        	//showAtLocation(anchor, Gravity.TOP, mPopupY ,90);//	
	        	showAsDropDown(anchor);
	        } 
	}
