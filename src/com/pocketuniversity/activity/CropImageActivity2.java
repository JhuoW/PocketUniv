...
public class CropImageActivity2 extends Activity implements OnClickListener{
    ...
    private void init(){
        ...
        try{
        	mBitmap = AbFileUtil.getBitmapFromSD(mFile);
        			;
            if(mBitmap==null){
    			finish();
            }else{
