...
public class AddTiaoZaoCommentActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tiaozao_add_comment);
		postId = getIntent().getStringExtra("postId");
		cater = getIntent().getIntExtra("cater", 0);
		method = C.ADDGOODSCOMMENTS;
		findView();
		setListener();
		initAction();
	...
	private void initAction(){
		...
		headerLayout.showLeftBackButton(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				AddTiaoZaoCommentActivity.this.finish();
			}
		});
				...
				new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if (commentcontent.length() == 0) {
							new SweetAlertDialog(AddTiaoZaoCommentActivity.this,SweetAlertDialog.WARNING_TYPE)
							.setTitleText("评论不能为空")
							.setConfirmText("确定")
							.setCancelText("取消")
