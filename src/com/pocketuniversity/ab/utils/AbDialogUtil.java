...
import com.pocketuniversity.ab.utils.AbAlertDialogFragment.AbDialogOnClickListener;
...
public class AbDialogUtil {
	...
	/**
	 * 显示�?个一般的对话框（图标，标题，string内容，确认，取消�?.
	 * @param context
	 * @param icon
	 * @param title 对话框标题内�?
	 * @param message 对话框提示内�?
	 * @param onClickListener 点击确认按钮的事件监�?
	 */
	 ...
	 * @param indeterminateDrawable 用默认请�?0
