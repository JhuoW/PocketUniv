...
public class AbViewUtil {
	 ...
	 * RelativeLayout,如果计算的不准，就为RelativeLayout指定�?个高�?
	 * 
	 * @param absListView
	 *            the abs list view
	 * @param lineNumber
	 *            每行几个 ListView�?行一个item
	 * @param verticalSpace
	 *            the vertical space
	 */
	...
	/**
	 * 获得这个View的宽�?
	 * 测量这个view，最后�?�过getMeasuredWidth()获取宽度.
	 * @param view 要测量的view
	 * @return 测量过的view的宽�?
	 */
	...
	/**
	 * 获得这个View的高�?
	 * 测量这个view，最后�?�过getMeasuredHeight()获取高度.
	 * @param view 要测量的view
	 * @return 测量过的view的高�?
	 */
	 ...
	 * 要求布局中的单位都用px并且和美工的设计图尺寸一致，包括�?有宽高，Padding,Margin,文字大小
	 * @param contentView
	 */
