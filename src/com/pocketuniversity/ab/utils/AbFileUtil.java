...
public class AbFileUtil {
	...
	private static int freeSdSpaceNeededToCache = 200*1024*1024;
	 ...
	 /**
	  * 描述：�?�过文件的网络地�?从SD卡中读取图片，如果SD中没有则自动下载并保�?.
	  * @param url 文件的网络地�?
	  * @param type 图片的处理类型（剪切或�?�缩放到指定大小，参考AbImageUtil类）
	  * 如果设置为原图，则后边参数无效，得到原图
	  * @param desiredWidth 新图片的�?
	  * @param desiredHeight 新图片的�?
	  * @return Bitmap 新图�?
	  */
 	 ...
 	 *
 	 * @param file the file
 	 * @param type 图片的处理类型（剪切或�?�缩放到指定大小，参考AbConstant类）
 	 * 如果设置为原图，则后边参数无效，得到原图
 	 * @param desiredWidth 新图片的�?
 	 * @param desiredHeight 新图片的�?
 	 * @return Bitmap 新图�?
     ...
     */
	  ...
	  * @param fileName 文件名称，需要包含后�?，如.jpg
	  * @param type 图片的处理类型（剪切或�?�缩放到指定大小，参考AbConstant类）
	  * @param desiredWidth 新图片的�?
	  * @param desiredHeight 新图片的�?
	  * @return Bitmap 新图�?
